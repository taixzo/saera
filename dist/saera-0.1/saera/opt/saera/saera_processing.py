...
#import sentences.sentences_german as sent
...
def parse_input(input):
	...
	elif exists_in_order(['my','location'],input.split()):
		return where_am_i(input)
...
def where_am_i(input):
	return sent.heres_where_you_are, "gobject.timeout_add(os.system,'python /opt/modrana/modrana.py --center-on-position')"
